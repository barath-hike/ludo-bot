...
def run_game(num_ep, model_output):
    ...
    agent0.load('./model_output/DQN_2p/0002/weights_40000.hdf5')
    ...
    output_dir = 'model_output/DQN_2p/%s/' % model_output

    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    for ep in tqdm(range(40_001, num_ep), ascii=True, unit="e"):
