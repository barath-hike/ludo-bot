...
from Boards.Speed_leedo_2p_v4 import FullBoard
...
def run_game(num_ep, model_output):
    ...
    output_dir_a = 'model_output_vs_intbot/A2C_v4_batch/%s/actor/' % model_output
    output_dir_c = 'model_output_vs_intbot/A2C_v4_batch/%s/critic/' % model_output
        ...
        while not game_over:
            ...
            if player_turn == player_turn_temp:
                ...
                if action_list:
                    ...
                    s_, reward, game_over, player_turn_temp, reward1 = env.make_step(action)
