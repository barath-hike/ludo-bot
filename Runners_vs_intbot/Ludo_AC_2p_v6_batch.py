...
def run_game(num_ep, model_output):
    ...
    # output_dir_a = '../trainers_vs_intbot/model_output_vs_intbot/A2C_v6_batch/0001/actor/weights_700000.hdf5'
    # output_dir_c = '../trainers_vs_intbot/model_output_vs_intbot/A2C_v6_batch/0001/critic/weights_700000.hdf5'
    ...
    output_dir_a = 'model_output_vs_intbot/A2C_v6_batch/%s/actor/' % model_output
    output_dir_c = 'model_output_vs_intbot/A2C_v6_batch/%s/critic/' % model_output
